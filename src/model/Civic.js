...
var civicsDict = {
  ...
  "Divided Attention": new Civic("Divided Attention", ["Hive Mind"], ["Hive Mind"], ["none"], ["none"], {"countryCoreSectorSystemCap": 2}),
  "Strength of Legions": new Civic("Strength of Legions", ["Hive Mind"], ["Hive Mind"], ["none"], ["none"], {"armyDamageMult": 0.2, "armyUpkeepMult": -0.2}),
  "Subsumed Will": new Civic("Subsumed Will", ["Hive Mind"], ["Hive Mind"], ["none"], ["none"], {"countryResourceInfluenceAdd": 1}),
  "Pooled Knowledge": new Civic("Pooled Knowledge", ["Hive Mind"], ["Hive Mind"], ["none"], ["none"], {"leaderSkillLevels": 1, "countryLeaderPoolSize": 1}),
  "Devouring Swarm": new Civic("Devouring Swarm", ["Hive Mind"], ["Hive Mind"], ["none"], ["none"], {"shipHitpointsMult": 0.1,
